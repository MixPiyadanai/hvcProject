    ...
    <div class="card-body p-3 m-0">
        <div class="row">
            <div class="col slit-in-vertical">
                            ...
                            <div class="card-body p-0">
                                <div class="row">
                                    ...
                                    <div class="col-9 pe-3 pt-2" style="border-radius: 15px">
                                        <h4 class="Itim">วิทยาลัยเทคนิคเชียงใหม่</h4>
                                        <h5 class="Itim">โดย วิทยาลัยเทคนิคเชียงใหม่</h5>
                                        <hr>
                ...
                <a href="#" class="btn btn-primary btn-lg mx-auto d-block Promt">ดูทั้งหมด</a>
            </div>
        </div>
    </div>
</div>