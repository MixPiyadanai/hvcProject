<header  style="box-shadow: rgba(207, 0, 0, 1) 0px 0px 0px 2px, rgba(6, 24, 44, 0.65) 0px 4px 6px -1px, rgba(255, 255, 255, 0.08) 0px 1px 0px inset;">
    <div class="inner-width">
        <a href="index.php" class="logo d-none d-sm-block"><img src="http://it.cmtc.ac.th/web2017/photo/logo/2017/1513260726_1-org.png" alt=""></a>
        ...
        <nav class="navigation-menu">
            ...
            <a href="#"><i class="fas fa-headset contact"></i> ติดต่อเรา</a>
            <a href="report.php"><i class="fas fa-sticky-note report"></i> รายงาน</a>
            <a href="profile.php"><i class="fas fa-users team"></i> บัญชีผู้ใช้</a>
        </nav>
    </div>
</header>